...
def main():
    ...
    with tab2:
        ...
        with st.expander("A.S. Mathematics, Physics and Computer Science - Moorpark College"):
            ...
            st.write("I graduated from Moorpark College in 2022 and transferred to UCLA. At Moorpark College I studied Mathematics, Physics and Computer Science. I was also an active particupant of many activities and societies: Deans List (2020-2022), Honor Roll (2020 - 2022), Phi Theta Kappa Honors Society 2020-present, Nasa Community College Aerospace Scholars Internship. ")
